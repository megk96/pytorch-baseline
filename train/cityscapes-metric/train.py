...
from pytorch_baseline.utils import joint_transforms
from pytorch_baseline.utils import transforms as extended_transforms
from pytorch_baseline.datasets import cityscapes
from pytorch_baseline.models import *
from pytorch_baseline.utils import check_mkdir, evaluate, AverageMeter, CrossEntropyLoss2d
...
def main():
    ...
    net = MLP([3, cityscapes.num_classes]).cuda()
    ...
    short_size = int(min(args['input_size']) / 1)
